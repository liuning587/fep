...
public class Packet376Event36 extends PmPacket376EventBase {
    ...
    public List<Meter36> meters = new ArrayList<Meter36>();
    ...
    protected void DecodeEventDetail(BcdDataBuffer eventData, int len) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("端口号=").append(this.Tongxunduankou).append(" ");
        sb.append("详细信息：(");
        for (Meter36 event : this.meters) {
